...
public class Classify {
	...
	public void run(String featureFile, String sampleFile, double ratio,
			String testResultFile, String nextFile) throws Exception {
		Instances instances = insGetter.getInstances(sampleFile);
		...
		this.train();
		Map map = this.test(testResultFile);
		this.writeSuspiciousToFile(nextFile);
	}
